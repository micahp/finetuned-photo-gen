...
export const VIDEO_MODELS: VideoModel[] = [
  ...
  {
    id: 'seedance-2-5-image',
    name: 'Seedance 2.5 – Image → Video',
  ...
  },
  {
    ...
    name: 'Seedance 2.5 – Reference → Video',
  ...
  {
    id: 'kling-v3-pro-image',
    name: 'Kling 3 Pro – Image → Video',
    falModelId: 'fal-ai/kling-video/v3/pro/image-to-video',
    mode: 'image-to-video',
    maxDuration: 20,
    costPerSecond: 35, // Estimated, similar to 2.1 Master
    supportedAspectRatios: ['16:9', '9:16', '1:1', '3:4', '4:3'],
    defaultParams: { fps: 24, motionLevel: 5 },
    durationOptions: [5, 10],
    audioMode: 'none',
  ...
  {
    id: 'kling-v3-standard-image',
    name: 'Kling 3 Standard – Image → Video',
    falModelId: 'fal-ai/kling-video/v3/standard/image-to-video',
    mode: 'image-to-video',
    maxDuration: 20,
    costPerSecond: 14, // Estimated
    supportedAspectRatios: ['16:9', '9:16', '1:1', '3:4', '4:3'],
    defaultParams: { fps: 24, motionLevel: 5 },
    durationOptions: [5, 10],
    audioMode: 'none',
  ...
  },
  {
    ...
    name: 'Kling 2.5 Turbo Pro – Image → Video',
    falModelId: 'fal-ai/kling-video/v2.5-turbo/pro/image-to-video',
    mode: 'image-to-video',
    maxDuration: 20,
    costPerSecond: 20, // Estimated, faster/cheaper
    supportedAspectRatios: ['16:9', '9:16', '1:1', '3:4', '4:3'],
    defaultParams: { fps: 24, motionLevel: 5 },
    durationOptions: [5, 10],
    audioMode: 'none',
