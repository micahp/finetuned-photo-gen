...
ARG STRIPE_CREATOR_PLAN_PRICE_ID
ARG STRIPE_PRO_PLAN_PRICE_ID
ARG STRIPE_ULTRA_PLAN_PRICE_ID
ARG NEXTAUTH_SECRET
ARG DATABASE_URL
...
ENV STRIPE_CREATOR_PLAN_PRICE_ID=${STRIPE_CREATOR_PLAN_PRICE_ID}
ENV STRIPE_PRO_PLAN_PRICE_ID=${STRIPE_PRO_PLAN_PRICE_ID}
ENV STRIPE_ULTRA_PLAN_PRICE_ID=${STRIPE_ULTRA_PLAN_PRICE_ID}
